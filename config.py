...
def parse():
    ...
    p.add_argument('--dataset', type=str, default='pubmed', help='dataset name (e.g.: cora/dblp for coauthorship, cora/citeseer/pubmed for cocitation)')
    p.add_argument('--model-name', type=str, default='UniGCNII', help='UniGNN Model(UniGCN, UniGAT, UniGIN, UniSAGE...)')
